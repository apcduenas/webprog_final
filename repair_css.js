...
// Re-import and apply blurry versions based on current structure (from view_file 815)
// Dark: starts at line 65 ends at 98 (34 lines)
lines.splice(64, 98 - 65 + 1, blurryDark);

// Blue: starts at line 101 ends at 134. But splice shifted it.
// Original lines was 2372.
// After first splice, lines shifted. The 'ignite-flicker-blue' was around line 101.
// Since splice(64, 34, blurryDark) replaced 34 lines with 1 line, we subtract 33 from following indices.
// Original 101 -> 101 - 33 = 68.
// No, it's safer to find it.

let content = lines.join('\n');
content = content.replace(/@keyframes ignite-flicker-blue \{[\s\S]*?\}/, blurryBlue);

// Restore drop-shadow filter in .ignite-text
content = content.replace(/\.ignite-text \{([\s\S]*?)letter-spacing: 2px;([\s\S]*?)\}/,
...
console.log('Restored blurry animations and drop-shadows');
